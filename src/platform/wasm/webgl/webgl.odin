...
Uniform2fv :: proc "c" (location: i32, v: [2]f32)  { Uniform2f(location, v.x, v.y) }
Uniform3fv :: proc "c" (location: i32, v: [3]f32)  { Uniform3f(location, v.x, v.y, v.z) }
Uniform4fv :: proc "c" (location: i32, v: [4]f32)  { Uniform4f(location, v.x, v.y, v.z, v.w) }
Uniform1iv :: proc "c" (location: i32, v: i32)       { Uniform1i(location, v) }
Uniform2iv :: proc "c" (location: i32, v: [2]i32) { Uniform2i(location, v.x, v.y) }
Uniform3iv :: proc "c" (location: i32, v: [3]i32) { Uniform3i(location, v.x, v.y, v.z) }
Uniform4iv :: proc "c" (location: i32, v: [4]i32) { Uniform4i(location, v.x, v.y, v.z, v.w) }

VertexAttrib1fv :: proc "c" (index: i32, v: f32)     { VertexAttrib1f(index, v) }
VertexAttrib2fv :: proc "c" (index: i32, v: [2]f32){ VertexAttrib2f(index, v.x, v.y) }
VertexAttrib3fv :: proc "c" (index: i32, v: [3]f32){ VertexAttrib3f(index, v.x, v.y, v.z) }
VertexAttrib4fv :: proc "c" (index: i32, v: [4]f32){ VertexAttrib4f(index, v.x, v.y, v.z, v.w) }
